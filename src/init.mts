...
import { ifEnable, isEnable } from '@app/modules/enable.mjs';
...
export type handlers = {
	IRC: import( '@app/lib/handlers/IRCMessageHandler.mjs' ).IRCMessageHandler;
	Telegram: import( '@app/lib/handlers/TelegramMessageHandler.mjs' ).TelegramMessageHandler;
	Discord: import( '@app/lib/handlers/DiscordMessageHandler.mjs' ).DiscordMessageHandler;
};

type handlerClasses = {
	IRC: {
		object: typeof import( '@app/lib/handlers/IRCMessageHandler.mjs' ).IRCMessageHandler;
		options: typeof config.IRC;
	};
	Telegram: {
		object: typeof import( '@app/lib/handlers/TelegramMessageHandler.mjs' ).TelegramMessageHandler;
		options: typeof config.Telegram;
	};
	Discord: {
		object: typeof import( '@app/lib/handlers/DiscordMessageHandler.mjs' ).DiscordMessageHandler;
...
for ( const client of enabledClients ) {
	...
	const Handler: typeof MessageHandler = ( await import( `@app/lib/handlers/${ allHandlers.get( client ) }.mjs` ) )[ allHandlers.get( client ) ];
